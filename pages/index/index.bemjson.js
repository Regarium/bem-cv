          ...
          answer: [
...

            {
              ...
              items: [
                ...
                'Разработал систему(на Друпале) для централизованного контроля несколькими интернет магазинами, где Multishop вступает в роле сервера а магазины в роле клиентa.'
              ]
            },
    ...
    },
    {
      ...
      data: [
          ...
          answer: {
            ...
            content: {
              ...
              content: [
                ...
                "  var self = this,", '<br>',
                "      needle = country.toLowerCase(),", '<br>',
                "      cars = [];", '<br>',
                "", '<br>',
                "  cars = self.cars.filter(function (car) {", '<br>',
                "    var result = getCountry.call(car);", '<br>',
                "    return (result)? result.toLowerCase() === needle : false;", '<br>',
                "  });", '<br>',
                "", '<br>',
                "  return cars.join(', ');", '<br>',
                "};", '<br>',
        ...
        },
        {
          ...
          answer: {
            ...
            content: {
              block: 'b-code',
              language: 'bash',
              content: 'find . -type f -name *yandex*.txt -exec grep -l -i "школа разработки интерфейсов" {} \';
            }
          }
        },
        {
        ...
        },
        {
          ...
          answer: 'Программирования, алгоритмы, структуры, парадигмы: в рамках университетской программы, допольнительно интересуюсь ресурсами Lullabot, Lyunda.com, Pluralsight, Standford, MIT'
        }
      ]
    },
    {
